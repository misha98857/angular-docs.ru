...
## Выявление ненужных вызовов обнаружения изменений {#identifying-unnecessary-change-detection-calls}
...
## Запуск задач за пределами `NgZone` {#run-tasks-outside-ngzone}
