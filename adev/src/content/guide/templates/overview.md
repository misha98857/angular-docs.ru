...
Используйте специальный синтаксис внутри шаблона, чтобы использовать многие возможности Angular.
...
Шаблоны основаны на синтаксисе [HTML](https://developer.mozilla.org/en-US/docs/Web/HTML) с дополнительными функциями,
такими как встроенные функции шаблонов, привязка данных, прослушивание событий, переменные и многое другое.

Angular компилирует шаблоны в JavaScript, чтобы создать внутреннее понимание вашего приложения. Одним из преимуществ
...
Кроме того, хотя большинство синтаксиса HTML является допустимым синтаксисом шаблона, Angular не поддерживает элемент
