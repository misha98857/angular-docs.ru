...
1. На этом этапе вы можете убедиться, что маршрутизация работает в вашем приложении. В браузере обновите домашнюю
   страницу и нажмите кнопку "Подробнее" для любого объекта жилья.
...
1. В браузере нажмите на одну из ссылок "Подробнее" и убедитесь, что числовое значение, отображаемое на странице,
...
1. В браузере обновите страницу и убедитесь, что при нажатии на ссылку "Подробнее" для данного жилья страница с
